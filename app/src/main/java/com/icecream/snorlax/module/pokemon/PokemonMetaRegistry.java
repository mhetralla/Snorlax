...
final class PokemonMetaRegistry {

	private static EnumMap<PokemonFamilyId, PokemonId> sHighestForFamily = new EnumMap<>(PokemonFamilyId.class);
	private static EnumMap<PokemonId, PokemonMeta> sMeta = new EnumMap<>(PokemonId.class);

	static {
		sHighestForFamily.put(PokemonFamilyId.FAMILY_BULBASAUR, PokemonId.VENUSAUR);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_CHARMANDER, PokemonId.CHARIZARD);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_SQUIRTLE, PokemonId.BLASTOISE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_CATERPIE, PokemonId.BUTTERFREE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_WEEDLE, PokemonId.BEEDRILL);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_PIDGEY, PokemonId.PIDGEOT);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_RATTATA, PokemonId.RATICATE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_SPEAROW, PokemonId.FEAROW);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_EKANS, PokemonId.ARBOK);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_PIKACHU, PokemonId.RAICHU);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_SANDSHREW, PokemonId.SANDSLASH);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_NIDORAN_FEMALE, PokemonId.NIDOQUEEN);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_NIDORAN_MALE, PokemonId.NIDOKING);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_CLEFAIRY, PokemonId.CLEFABLE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_VULPIX, PokemonId.NINETALES);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_JIGGLYPUFF, PokemonId.WIGGLYTUFF);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_ZUBAT, PokemonId.GOLBAT);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_ODDISH, PokemonId.VILEPLUME);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_PARAS, PokemonId.PARASECT);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_VENONAT, PokemonId.VENOMOTH);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_DIGLETT, PokemonId.DUGTRIO);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MEOWTH, PokemonId.PERSIAN);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_PSYDUCK, PokemonId.GOLDUCK);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MANKEY, PokemonId.PRIMEAPE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_GROWLITHE, PokemonId.ARCANINE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_POLIWAG, PokemonId.POLIWRATH);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_ABRA, PokemonId.ALAKAZAM);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MACHOP, PokemonId.MACHAMP);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_BELLSPROUT, PokemonId.VICTREEBEL);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_TENTACOOL, PokemonId.TENTACRUEL);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_GEODUDE, PokemonId.GOLEM);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_PONYTA, PokemonId.RAPIDASH);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_SLOWPOKE, PokemonId.SLOWBRO);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MAGNEMITE, PokemonId.MAGNETON);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_FARFETCHD, PokemonId.FARFETCHD);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_DODUO, PokemonId.DODRIO);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_SEEL, PokemonId.DEWGONG);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_GRIMER, PokemonId.MUK);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_SHELLDER, PokemonId.CLOYSTER);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_GASTLY, PokemonId.GENGAR);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_ONIX, PokemonId.ONIX);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_DROWZEE, PokemonId.HYPNO);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_KRABBY, PokemonId.KINGLER);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_VOLTORB, PokemonId.ELECTRODE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_EXEGGCUTE, PokemonId.EXEGGUTOR);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_CUBONE, PokemonId.MAROWAK);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_HITMONLEE, PokemonId.HITMONLEE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_HITMONCHAN, PokemonId.HITMONCHAN);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_LICKITUNG, PokemonId.LICKITUNG);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_KOFFING, PokemonId.WEEZING);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_RHYHORN, PokemonId.RHYDON);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_CHANSEY, PokemonId.CHANSEY);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_TANGELA, PokemonId.TANGELA);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_KANGASKHAN, PokemonId.KANGASKHAN);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_HORSEA, PokemonId.SEADRA);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_GOLDEEN, PokemonId.SEAKING);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_STARYU, PokemonId.STARMIE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MR_MIME, PokemonId.MR_MIME);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_SCYTHER, PokemonId.SCYTHER);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_JYNX, PokemonId.JYNX);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_ELECTABUZZ, PokemonId.ELECTABUZZ);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MAGMAR, PokemonId.MAGMAR);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_PINSIR, PokemonId.PINSIR);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_TAUROS, PokemonId.TAUROS);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MAGIKARP, PokemonId.GYARADOS);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_LAPRAS, PokemonId.LAPRAS);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_DITTO, PokemonId.DITTO);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_EEVEE, PokemonId.EEVEE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_PORYGON, PokemonId.PORYGON);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_OMANYTE, PokemonId.OMASTAR);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_KABUTO, PokemonId.KABUTOPS);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_AERODACTYL, PokemonId.AERODACTYL);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_SNORLAX, PokemonId.SNORLAX);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_ARTICUNO, PokemonId.ARTICUNO);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_ZAPDOS, PokemonId.ZAPDOS);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MOLTRES, PokemonId.MOLTRES);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_DRATINI, PokemonId.DRAGONITE);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MEWTWO, PokemonId.MEWTWO);
		sHighestForFamily.put(PokemonFamilyId.FAMILY_MEW, PokemonId.MEW);
		...
		metap.setNumber(1);
		sMeta.put(PokemonId.BULBASAUR, metap);
		...
		metap.setNumber(2);
		sMeta.put(PokemonId.IVYSAUR, metap);
		...
		metap.setNumber(3);
		sMeta.put(PokemonId.VENUSAUR, metap);
		...
		metap.setNumber(4);
		sMeta.put(PokemonId.CHARMANDER, metap);
		...
		metap.setNumber(5);
		sMeta.put(PokemonId.CHARMELEON, metap);
		...
		metap.setNumber(6);
		sMeta.put(PokemonId.CHARIZARD, metap);
		...
		metap.setNumber(7);
		sMeta.put(PokemonId.SQUIRTLE, metap);
		...
		metap.setNumber(8);
		sMeta.put(PokemonId.WARTORTLE, metap);
		...
		metap.setNumber(9);
		sMeta.put(PokemonId.BLASTOISE, metap);
		...
		metap.setNumber(10);
		sMeta.put(PokemonId.CATERPIE, metap);
		...
		metap.setNumber(11);
		sMeta.put(PokemonId.METAPOD, metap);
		...
		metap.setNumber(12);
		sMeta.put(PokemonId.BUTTERFREE, metap);
		...
		metap.setNumber(13);
		sMeta.put(PokemonId.WEEDLE, metap);
		...
		metap.setNumber(14);
		sMeta.put(PokemonId.KAKUNA, metap);
		...
		metap.setNumber(15);
		sMeta.put(PokemonId.BEEDRILL, metap);
		...
		metap.setNumber(16);
		sMeta.put(PokemonId.PIDGEY, metap);
		...
		metap.setNumber(17);
		sMeta.put(PokemonId.PIDGEOTTO, metap);
		...
		metap.setNumber(18);
		sMeta.put(PokemonId.PIDGEOT, metap);
		...
		metap.setNumber(19);
		sMeta.put(PokemonId.RATTATA, metap);
		...
		metap.setNumber(20);
		sMeta.put(PokemonId.RATICATE, metap);
		...
		metap.setNumber(21);
		sMeta.put(PokemonId.SPEAROW, metap);
		...
		metap.setNumber(22);
		sMeta.put(PokemonId.FEAROW, metap);
		...
		metap.setNumber(23);
		sMeta.put(PokemonId.EKANS, metap);
		...
		metap.setNumber(24);
		sMeta.put(PokemonId.ARBOK, metap);
		...
		metap.setNumber(25);
		sMeta.put(PokemonId.PIKACHU, metap);
		...
		metap.setNumber(26);
		sMeta.put(PokemonId.RAICHU, metap);
		...
		metap.setNumber(27);
		sMeta.put(PokemonId.SANDSHREW, metap);
		...
		metap.setNumber(28);
		sMeta.put(PokemonId.SANDSLASH, metap);
		...
		metap.setNumber(29);
		sMeta.put(PokemonId.NIDORAN_FEMALE, metap);
		...
		metap.setNumber(30);
		sMeta.put(PokemonId.NIDORINA, metap);
		...
		metap.setNumber(31);
		sMeta.put(PokemonId.NIDOQUEEN, metap);
		...
		metap.setNumber(32);
		sMeta.put(PokemonId.NIDORAN_MALE, metap);
		...
		metap.setNumber(33);
		sMeta.put(PokemonId.NIDORINO, metap);
		...
		metap.setNumber(34);
		sMeta.put(PokemonId.NIDOKING, metap);
		...
		metap.setNumber(35);
		sMeta.put(PokemonId.CLEFAIRY, metap);
		...
		metap.setNumber(36);
		sMeta.put(PokemonId.CLEFABLE, metap);
		...
		metap.setNumber(37);
		sMeta.put(PokemonId.VULPIX, metap);
		...
		metap.setNumber(38);
		sMeta.put(PokemonId.NINETALES, metap);
		...
		metap.setNumber(39);
		sMeta.put(PokemonId.JIGGLYPUFF, metap);
		...
		metap.setNumber(40);
		sMeta.put(PokemonId.WIGGLYTUFF, metap);
		...
		metap.setNumber(41);
		sMeta.put(PokemonId.ZUBAT, metap);
		...
		metap.setNumber(42);
		sMeta.put(PokemonId.GOLBAT, metap);
		...
		metap.setNumber(43);
		sMeta.put(PokemonId.ODDISH, metap);
		...
		metap.setNumber(44);
		sMeta.put(PokemonId.GLOOM, metap);
		...
		metap.setNumber(45);
		sMeta.put(PokemonId.VILEPLUME, metap);
		...
		metap.setNumber(46);
		sMeta.put(PokemonId.PARAS, metap);
		...
		metap.setNumber(47);
		sMeta.put(PokemonId.PARASECT, metap);
		...
		metap.setNumber(48);
		sMeta.put(PokemonId.VENONAT, metap);
		...
		metap.setNumber(49);
		sMeta.put(PokemonId.VENOMOTH, metap);
		...
		metap.setNumber(50);
		sMeta.put(PokemonId.DIGLETT, metap);
		...
		metap.setNumber(51);
		sMeta.put(PokemonId.DUGTRIO, metap);
		...
		metap.setNumber(52);
		sMeta.put(PokemonId.MEOWTH, metap);
		...
		metap.setNumber(53);
		sMeta.put(PokemonId.PERSIAN, metap);
		...
		metap.setNumber(54);
		sMeta.put(PokemonId.PSYDUCK, metap);
		...
		metap.setNumber(55);
		sMeta.put(PokemonId.GOLDUCK, metap);
		...
		metap.setNumber(56);
		sMeta.put(PokemonId.MANKEY, metap);
		...
		metap.setNumber(57);
		sMeta.put(PokemonId.PRIMEAPE, metap);
		...
		metap.setNumber(58);
		sMeta.put(PokemonId.GROWLITHE, metap);
		...
		metap.setNumber(59);
		sMeta.put(PokemonId.ARCANINE, metap);
		...
		metap.setNumber(60);
		sMeta.put(PokemonId.POLIWAG, metap);
		...
		metap.setNumber(61);
		sMeta.put(PokemonId.POLIWHIRL, metap);
		...
		metap.setNumber(62);
		sMeta.put(PokemonId.POLIWRATH, metap);
		...
		metap.setNumber(63);
		sMeta.put(PokemonId.ABRA, metap);
		...
		metap.setNumber(64);
		sMeta.put(PokemonId.KADABRA, metap);
		...
		metap.setNumber(65);
		sMeta.put(PokemonId.ALAKAZAM, metap);
		...
		metap.setNumber(66);
		sMeta.put(PokemonId.MACHOP, metap);
		...
		metap.setNumber(67);
		sMeta.put(PokemonId.MACHOKE, metap);
		...
		metap.setNumber(68);
		sMeta.put(PokemonId.MACHAMP, metap);
		...
		metap.setNumber(69);
		sMeta.put(PokemonId.BELLSPROUT, metap);
		...
		metap.setNumber(70);
		sMeta.put(PokemonId.WEEPINBELL, metap);
		...
		metap.setNumber(71);
		sMeta.put(PokemonId.VICTREEBEL, metap);
		...
		metap.setNumber(72);
		sMeta.put(PokemonId.TENTACOOL, metap);
		...
		metap.setNumber(73);
		sMeta.put(PokemonId.TENTACRUEL, metap);
		...
		metap.setNumber(74);
		sMeta.put(PokemonId.GEODUDE, metap);
		...
		metap.setNumber(75);
		sMeta.put(PokemonId.GRAVELER, metap);
		...
		metap.setNumber(76);
		sMeta.put(PokemonId.GOLEM, metap);
		...
		metap.setNumber(77);
		sMeta.put(PokemonId.PONYTA, metap);
		...
		metap.setNumber(78);
		sMeta.put(PokemonId.RAPIDASH, metap);
		...
		metap.setNumber(79);
		sMeta.put(PokemonId.SLOWPOKE, metap);
		...
		metap.setNumber(80);
		sMeta.put(PokemonId.SLOWBRO, metap);
		...
		metap.setNumber(81);
		sMeta.put(PokemonId.MAGNEMITE, metap);
		...
		metap.setNumber(82);
		sMeta.put(PokemonId.MAGNETON, metap);
		...
		metap.setNumber(83);
		sMeta.put(PokemonId.FARFETCHD, metap);
		...
		metap.setNumber(84);
		sMeta.put(PokemonId.DODUO, metap);
		...
		metap.setNumber(85);
		sMeta.put(PokemonId.DODRIO, metap);
		...
		metap.setNumber(86);
		sMeta.put(PokemonId.SEEL, metap);
		...
		metap.setNumber(87);
		sMeta.put(PokemonId.DEWGONG, metap);
		...
		metap.setNumber(88);
		sMeta.put(PokemonId.GRIMER, metap);
		...
		metap.setNumber(90);
		sMeta.put(PokemonId.SHELLDER, metap);
		...
		metap.setNumber(91);
		sMeta.put(PokemonId.CLOYSTER, metap);
		...
		metap.setNumber(92);
		sMeta.put(PokemonId.GASTLY, metap);
		...
		metap.setNumber(93);
		sMeta.put(PokemonId.HAUNTER, metap);
		...
		metap.setNumber(94);
		sMeta.put(PokemonId.GENGAR, metap);
		...
		metap.setNumber(95);
		sMeta.put(PokemonId.ONIX, metap);
		...
		metap.setNumber(96);
		sMeta.put(PokemonId.DROWZEE, metap);
		...
		metap.setNumber(97);
		sMeta.put(PokemonId.HYPNO, metap);
		...
		metap.setNumber(98);
		sMeta.put(PokemonId.KRABBY, metap);
		...
		metap.setNumber(99);
		sMeta.put(PokemonId.KINGLER, metap);
		...
		metap.setNumber(100);
		sMeta.put(PokemonId.VOLTORB, metap);
		...
		metap.setNumber(101);
		sMeta.put(PokemonId.ELECTRODE, metap);
		...
		metap.setNumber(102);
		sMeta.put(PokemonId.EXEGGCUTE, metap);
		...
		metap.setNumber(103);
		sMeta.put(PokemonId.EXEGGUTOR, metap);
		...
		metap.setNumber(104);
		sMeta.put(PokemonId.CUBONE, metap);
		...
		metap.setNumber(105);
		sMeta.put(PokemonId.MAROWAK, metap);
		...
		metap.setNumber(106);
		sMeta.put(PokemonId.HITMONLEE, metap);
		...
		metap.setNumber(107);
		sMeta.put(PokemonId.HITMONCHAN, metap);
		...
		metap.setNumber(108);
		sMeta.put(PokemonId.LICKITUNG, metap);
		...
		metap.setNumber(109);
		sMeta.put(PokemonId.KOFFING, metap);
		...
		metap.setNumber(110);
		sMeta.put(PokemonId.WEEZING, metap);
		...
		metap.setNumber(111);
		sMeta.put(PokemonId.RHYHORN, metap);
		...
		metap.setNumber(112);
		sMeta.put(PokemonId.RHYDON, metap);
		...
		metap.setNumber(113);
		sMeta.put(PokemonId.CHANSEY, metap);
		...
		metap.setNumber(114);
		sMeta.put(PokemonId.TANGELA, metap);
		...
		metap.setNumber(115);
		sMeta.put(PokemonId.KANGASKHAN, metap);
		...
		metap.setNumber(116);
		sMeta.put(PokemonId.HORSEA, metap);
		...
		metap.setNumber(117);
		sMeta.put(PokemonId.SEADRA, metap);
		...
		metap.setNumber(118);
		sMeta.put(PokemonId.GOLDEEN, metap);
		...
		metap.setNumber(119);
		sMeta.put(PokemonId.SEAKING, metap);
		...
		metap.setNumber(120);
		sMeta.put(PokemonId.STARYU, metap);
		...
		metap.setNumber(121);
		sMeta.put(PokemonId.STARMIE, metap);
		...
		metap.setNumber(122);
		sMeta.put(PokemonId.MR_MIME, metap);
		...
		metap.setNumber(123);
		sMeta.put(PokemonId.SCYTHER, metap);
		...
		metap.setNumber(124);
		sMeta.put(PokemonId.JYNX, metap);
		...
		metap.setNumber(125);
		sMeta.put(PokemonId.ELECTABUZZ, metap);
		...
		metap.setNumber(126);
		sMeta.put(PokemonId.MAGMAR, metap);
		...
		metap.setNumber(127);
		sMeta.put(PokemonId.PINSIR, metap);
		...
		metap.setNumber(128);
		sMeta.put(PokemonId.TAUROS, metap);
		...
		metap.setNumber(129);
		sMeta.put(PokemonId.MAGIKARP, metap);
		...
		metap.setNumber(130);
		sMeta.put(PokemonId.GYARADOS, metap);
		...
		metap.setNumber(131);
		sMeta.put(PokemonId.LAPRAS, metap);
		...
		metap.setNumber(132);
		sMeta.put(PokemonId.DITTO, metap);
		...
		metap.setNumber(133);
		sMeta.put(PokemonId.EEVEE, metap);
		...
		metap.setNumber(134);
		sMeta.put(PokemonId.VAPOREON, metap);
		...
		metap.setNumber(135);
		sMeta.put(PokemonId.JOLTEON, metap);
		...
		metap.setNumber(136);
		sMeta.put(PokemonId.FLAREON, metap);
		...
		metap.setNumber(137);
		sMeta.put(PokemonId.PORYGON, metap);
		...
		metap.setNumber(138);
		sMeta.put(PokemonId.OMANYTE, metap);
		...
		metap.setNumber(139);
		sMeta.put(PokemonId.OMASTAR, metap);
		...
		metap.setNumber(140);
		sMeta.put(PokemonId.KABUTO, metap);
		...
		metap.setNumber(141);
		sMeta.put(PokemonId.KABUTOPS, metap);
		...
		metap.setNumber(142);
		sMeta.put(PokemonId.AERODACTYL, metap);
		...
		metap.setNumber(143);
		sMeta.put(PokemonId.SNORLAX, metap);
		...
		metap.setNumber(144);
		sMeta.put(PokemonId.ARTICUNO, metap);
		...
		metap.setNumber(145);
		sMeta.put(PokemonId.ZAPDOS, metap);
		...
		metap.setNumber(146);
		sMeta.put(PokemonId.MOLTRES, metap);
		...
		metap.setNumber(147);
		sMeta.put(PokemonId.DRATINI, metap);
		...
		metap.setNumber(148);
		sMeta.put(PokemonId.DRAGONAIR, metap);
		...
		metap.setNumber(149);
		sMeta.put(PokemonId.DRAGONITE, metap);
		...
		metap.setNumber(150);
		sMeta.put(PokemonId.MEWTWO, metap);
		...
		metap.setNumber(151);
		sMeta.put(PokemonId.MEW, metap);
	}

	static PokemonMeta getMeta(PokemonId id) {
		return sMeta.get(id);
	}

	static PokemonId getHighestForFamily(PokemonFamilyId family) {
		return sHighestForFamily.get(family);
	}

	private PokemonMetaRegistry() {
