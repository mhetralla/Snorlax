...
final class GameMasterPreferences {
	...
	@Inject
	GameMasterPreferences(@Snorlax Resources resources, XSharedPreferences preferences) {
		mResources = resources;
		mPreferences = preferences;
	}

	<T> Observable.Transformer<T, T> isEnabled() {
		return PreferencesUtil.isEnabled(mPreferences, mResources, R.bool.preference_gamemaster_enable_default, R.string.preference_gamemaster_enable_key);
	}
}