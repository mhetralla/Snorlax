...
@Singleton
final class PokebagPreferences {

	private final Resources mResources;
	private final XSharedPreferences mPreferences;

	@Inject
	PokebagPreferences(@Snorlax Resources resources, XSharedPreferences preferences) {
		mResources = resources;
		mPreferences = preferences;
	}

	<T> Observable.Transformer<T, T> isEnabled() {
		return PreferencesUtil.isEnabled(mPreferences, mResources, R.bool.preference_bag_pokemon_enable_default, R.string.preference_bag_pokemon_enable_key);
	}
}
