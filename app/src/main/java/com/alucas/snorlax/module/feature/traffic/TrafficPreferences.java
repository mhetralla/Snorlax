...
final class TrafficPreferences {
	...
	@Inject
	TrafficPreferences(@Snorlax Resources resources, XSharedPreferences preferences) {
		mResources = resources;
		mPreferences = preferences;
	}

	<T> Observable.Transformer<T, T> isEnabled() {
		return PreferencesUtil.isEnabled(mPreferences, mResources, R.bool.preference_log_traffic_enable_default, R.string.preference_log_traffic_enable_key);
	}
}
